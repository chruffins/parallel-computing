...
void draw_line(int x1, int y1, int x2, int y2, float *arr) {
    int dx = abs(x2 - x1);
    int dy = -abs(y2 - y1);
    int signx = (x1 < x2) ? 1 : -1;
    int signy = (y1 < y2) ? 1 : -1;
...
int main( void ) {
    ...
    for (int s = 0; s < sides; s++) {
        float a1 = (s * 2 * PI / sides);
        float a2 = ((s + 1) * 2 * PI / sides);

        draw_line(450 + (150 * cos(a1)), 450 + (150 * sin(a1)), 450 + (150 * cos(a2)), 450 + (150 * sin(a2)), temp);
        printf("%.2f %.2f\n", 450 + (150 * cos(a1)), 450 + (150 * sin(a1)));
    }
